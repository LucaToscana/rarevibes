...
export const artistFieldsConfig = [
  ...
  { id: "merch-price-va-1", label: "Prezzo 1", type: "text", group: "merch" },
  {
    id: "merch-image-va-1",
    label: "Immagine (URL o percorso) 1",
    type: "url",
    group: "merch",
  },
  {
  ...
  { id: "merch-price-va-2", label: "Prezzo 2", type: "text", group: "merch" },
  {
    id: "merch-image-va-2",
    label: "Immagine (URL o percorso) 2",
    type: "url",
    group: "merch",
  },
  {
  ...
  { id: "merch-price-va-3", label: "Prezzo 3", type: "text", group: "merch" },
  {
    id: "merch-image-va-3",
    label: "Immagine (URL o percorso) 3",
    type: "url",
    group: "merch",
  },
  {
...
export const musicianFieldsConfig = [
  ...
  { id: "bio-review-mu", label: "Recensione", type: "textarea", group: "main" },
  {
    id: "bio-extended-mu",
    label: "Biografia Estesa",
    type: "textarea",
  ...
  { id: "label-mu", label: "Etichetta", type: "text", group: "main" },

  // Single (senza group, campi piatti)
  {
    id: "single-title-mu",
    label: "Titolo Singolo",
    type: "text",
    required: true,
    group: "track",
  },
  ...
  {
    id: "single-cover-mu",
    label: "Copertina Singolo (URL o percorso)",
    type: "url",
    group: "track",
  },
  {
    id: "single-featuring-mu",
    label: "Featuring (tag multipli separati da virgola)",
    type: "tags",
    group: "track",
  },

  // Link piattaforme singolo
  {
    id: "single-platform-spotify-mu",
    label: "Spotify Singolo",
    type: "url",
    group: "track",
  },
  {
    id: "single-platform-youtube-mu",
    label: "YouTube Singolo (video ID o URL)",
    type: "text",
    group: "track",
  },
  {
    id: "single-platform-bandcamp-mu",
    label: "Bandcamp Singolo",
    type: "text",
    group: "track",
  },
  {
    id: "single-platform-soundcloud-mu",
    label: "SoundCloud Singolo",
    type: "url",
    group: "track",
  },
  {
    id: "single-platform-appleMusic-mu",
    label: "Apple Music Singolo",
    type: "url",
    group: "track",
  },
  {
    id: "single-platform-deezer-mu",
    label: "Deezer Singolo",
    type: "url",
    group: "track",
  },
  {
  ...
  { id: "website-mu", label: "Sito Web", type: "url", group: "social" },
