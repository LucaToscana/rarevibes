...
export default function CardForm() {
  return (
    <div className="relative font-arvo w-80 p-6 bg-white border-[8px] border-black shadow-[15px_15px_0px_#000] rotate-[-2deg] transition-all duration-300 ease-in-out hover:rotate-0 hover:scale-105 hover:shadow-[20px_20px_0px_#000] active:animate-shake overflow-hidden">
      ...
      <div className="absolute top-1 right-[-95px] w-[350px] bg-black text-white py-3 text-center text-[18px] font-bold tracking-widest rotate-45 transition-colors duration-500 hover:bg-red-600 overflow-hidden">
        <div className="relative w-full h-full">
          <span className="absolute left-[13%] top-1/2 -translate-y-1/2 transition-all duration-500 banner-text font-arvo">
            JOIN NOW
          </span>
